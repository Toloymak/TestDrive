    ...
    return <div className="popup">
      <div className="popupWarning-content">
        ...
        <div className="popupWarning-buttonGroup">
          <Button size="large" width={250} use="danger" onClick={()=>this.deleteService()}>Удалить</Button>
          <Button size="large" width={250} use="primary" onClick={()=>this.props.close()}>Отмена</Button>
        </div>
