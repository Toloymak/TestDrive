  ...
  return (
    <div className="header">
      <div className="content header_content">
        ...
        {visiblePopupCreate ? (
          <Popup close={closePopup} showSpinner={showSpinner} />
        ) : null}
      </div>
      {visibleListTestSocket && (
        <TestSocket
          visibleListTestSocket={visibleListTestSocket}
          toggleVisibleListTestSocket={toggleVisibleListTestSocket}
        />
      )}
    </div>
  );
