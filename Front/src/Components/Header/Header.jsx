  ...
  render() {
    return <div className="header">
      <div className="content header_content">
        ...
        <Button onClick={()=>this.openPopup()} use="primary" size="medium" width="250px">Добавить сервис</Button>
        {
          this.state.visiblePopupCreate ? <Popup close={this.closePopup.bind(this)}
                                                 showSpinner={this.props.showSpinner}/> : null
        }
      </div>
    </div>
  }
